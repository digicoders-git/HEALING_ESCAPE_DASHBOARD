        ...
        <div className="flex flex-col md:flex-row justify-between items-center mb-4 gap-4">
          ...
          <div className="flex flex-wrap gap-2 w-full md:w-auto">
            ...
            <button
              ...
              className="hidden md:flex items-center gap-2 px-6 py-3 rounded-xl shadow-lg font-bold transition-all hover:scale-105 active:scale-95"
              style={{ backgroundColor: '#1db64c', color: '#ffffff' }}
            >
              <MdAdd size={22} /> Create Lead
            </button>
          </div>
        </div>
                ...
                <table className="w-full text-left border-collapse">
                  ...
                  >
                    <tr>
                      ...
                      <th className="p-4 font-bold text-sm text-white">#</th>
                      ...
                      <th className="p-4 font-bold text-sm text-white text-center">
                        STATUS
                      </th>
                  ...
                  <tbody>
                    {data.map((item, index) => (
                      ...
                      >
                        ...
                        <td className="p-4">
                          <div className="font-bold text-sm" style={{ color: '#006cb5' }}>
                            {item.fullName}
                          </div>

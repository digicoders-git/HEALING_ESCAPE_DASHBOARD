    ...
    try {
      ...
      if (response.success) {
        ...
        setFormData({
          ...
          hospitalCity: doc.hospital?.city || "",
          hospitalAccreditation: Array.isArray(doc.hospital?.accreditation)
            ? doc.hospital.accreditation.join(", ")
            : "",
          isActive: doc.isActive,
        });
        setImagePreview(doc.photo);
        setExpertise(Array.isArray(doc.expertise) ? doc.expertise : []);
        setProcedures(Array.isArray(doc.procedures) ? doc.procedures : []);
        setWhyChoose(Array.isArray(doc.whyChoose) ? doc.whyChoose : []);
      }
    } catch (error) {
          ...
          >
            ...
            >
              {submitting ? (
                ...
                <>
                  <MdSave size={20} /> Update Doctor Profile
                </>
              )}
            </button>
          </div>
